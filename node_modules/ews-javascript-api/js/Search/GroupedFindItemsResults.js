...
var GroupedFindItemsResults = (function () {
    function GroupedFindItemsResults() {
        ...
        this.itemGroups = []; //System.Collections.ObjectModel.Collection<ItemGroup<TItem>>;
    }
    Object.defineProperty(GroupedFindItemsResults.prototype, "ItemGroups", {
        get: function () { return this.itemGroups; } //System.Collections.ObjectModel.Collection<ItemGroup<TItem>>;
        ,
        enumerable: true,
        configurable: true
    });
