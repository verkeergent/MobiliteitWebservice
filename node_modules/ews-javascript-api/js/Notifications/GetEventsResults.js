        ...
        for (var key in eventsResponse) {
            switch (key) {
                ...
                case XmlElementNames_1.XmlElementNames.MoreEvents:
                    this.moreEventsAvailable = ExtensionMethods_1.Convert.toBool(eventsResponse[key]);
                    break;
                default:
                    if (GetEventsResults.XmlElementNameToEventTypeMap.containsKey(key)) {
                        this.LoadEventsFromXmlJsObject(EwsServiceJsonReader_1.EwsServiceJsonReader.ReadAsArray(eventsResponse, key), key, service);
                    }
                    break;
            }
        }
