...
var MarkAsJunkResponse = (function (_super) {
    ...
    MarkAsJunkResponse.prototype.ReadElementsFromXmlJsObject = function (responseObject, service) {
        ...
        if (responseObject.ContainsKey(XmlElementNames_1.XmlElementNames.Token)) {
            this.MovedItemId = new ItemId_1.ItemId();
            this.MovedItemId.LoadFromXmlJsObject(responseObject.ReadAsJsonObject(XmlElementNames_1.XmlElementNames.MovedItemId), service);
        }
    };
